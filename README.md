...
Inspired by the [cryptowat.ch](https://cryptowat.ch/) website, this [Real World React](https://www.meetup.com/Real-World-React/) August 24, 2017 [Hack Night](https://www.meetup.com/Real-World-React/events/242620292/) project was an excuse to play with React.js, APIs, web sockets, RX.js, and D3.js.  Project members included [Carol St. Louis](https://github.com/selva-oscura), [Neil Ricci](https://github.com/iccir919), and Swizec Teller ([website](https://swizec.com/), [github](https://github.com/Swizec)) who was an awesome mentor!
